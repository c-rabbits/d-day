    ...
    <div className="relative flex min-h-svh w-full flex-col overflow-hidden bg-[hsl(var(--auth-header))]">
      ...
      <header className="relative px-4 pt-6 pb-8">
        ...
        <div className="mt-5 space-y-2">
          ...
          <p className="max-w-[310px] text-sm leading-relaxed text-white/82">{subtitle}</p>
        </div>

        <VectorHero variant="compact" className="mt-6 border-white/20 bg-white/10" />
      </header>

      <div className="relative flex-1 rounded-t-[2rem] bg-surface px-6 pt-8 pb-10 shadow-[0_-20px_60px_-40px_rgba(0,0,0,0.65)]">
