...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-outline-variant/80 bg-card text-card-foreground shadow-[0_18px_34px_-28px_rgba(15,23,42,0.38)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col gap-2.5 p-7", className)}
    {...props}
  />
));
