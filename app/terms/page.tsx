...
const CLAUSES = [
  {
    title: "제1조 (목적)",
    body: "이 약관은 개인 사업자 \"머니게임\" (이하 \"회사\")가 제공하는 모바일 앱 및 웹 기반 서비스(이하 \"서비스\")의 이용과 관련하여 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.",
  },
  {
    title: "제2조 (정의)",
    items: [
      "\"서비스\"라 함은 회사가 제공하는 머니게임 앱, 웹(PWA), 알림 기능 등을 의미합니다.",
  ...
  },
  {
    ...
    items: [
      "머니게임 서비스는 이용자가 입력한 데이터를 기반으로 알림을 제공합니다.",
