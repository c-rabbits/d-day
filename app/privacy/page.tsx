...
const SECTIONS: Array<{
    ...
    subsections: [
      {
        ...
        items: [
          "이메일 주소",
          "비밀번호(암호화 저장)",
          "소셜 로그인 시 프로필 정보(닉네임, 프로필 사진) — 카카오/구글 제공",
        ],
      },
      {
        title: "② 서비스 이용 시 수집",
        items: [
          "푸시 토큰 (알림 발송용)",
          "추천 코드 및 추천인 관계 정보",
          "서비스 이용 기록 (XP, 미션 완료, 뱃지 등 게이미피케이션 데이터)",
        ],
      },
      {
        title: "③ 리더보드",
        items: [
          "닉네임, 프로필 사진, XP 점수가 리더보드에 공개될 수 있습니다.",
          "리더보드 노출을 원하지 않을 경우 고객센터로 문의해주세요.",
        ],
      },
      {
        title: "④ 유료 결제 시",
  ...
  },
  {
    ...
    items: ["Google Firebase (푸시 알림 및 인증)", "Google Play Billing (결제 처리)", "카카오 (소셜 로그인 — 닉네임, 프로필 사진 제공)"],
  },
  {
    title: "6. 이용자의 권리",
  ...
  {
    title: "9. 개인정보 보호책임자",
    body: "사업자명: 스튜디오 코니\n이메일: nemonade.dev@gmail.com",
  },
  {
    title: "10. 개인정보처리방침의 변경",
    body: "본 방침은 2026년 4월 2일부터 적용됩니다. 변경 시 앱 또는 웹사이트에 공지합니다.",
  },
];
