    ...
    return (
      <main className="relative min-h-screen overflow-hidden px-6 py-12">
        ...
        <div className="relative mx-auto flex w-full max-w-mobile flex-col gap-6">
          <section className="glass-panel rounded-[1.75rem] p-7">
  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 py-10">
      ...
      <div className="relative mx-auto flex w-full max-w-mobile flex-col gap-7">
        ...
        <section className="grid gap-3.5 pb-10">
          {[
            {
              title: "등록은 간단하게",
            ...
            <article
              key={item.title}
              className="rounded-2xl border border-outline-variant/70 bg-surface/80 p-5 backdrop-blur"
            >
